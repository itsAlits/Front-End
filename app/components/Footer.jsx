...
export default function Footer() {
  return (
    <motion.footer 
      ...
      className="bg-[#151515] text-white py-6 sm:py-8 md:py-12 mt-16 sm:mt-20"
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8 md:gap-6 lg:gap-8">
          ...
          >
            ...
            <ul className="text-gray-400 text-sm space-y-3">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Rekomendasi</a></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <div className="flex justify-start sm:justify-start space-x-6">
