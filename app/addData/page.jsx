...
export default function page() {
  ...
  return (
    <div className="min-h-screen">
      <SidebarAdmin
        active1={"flex items-center px-3 py-3 bg-primary transform "}
        activeIcon1={"#ffffff"}
        styleActive1={"mx-2 text-sm font-medium text-white"}
        active2={
          "flex items-center px-3 py-3 text-white transition-colors duration-300 transform  hover:bg-gray-100 hover:text-gray-700"
        }
